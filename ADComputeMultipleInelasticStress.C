...
ADComputeMultipleInelasticStress::initQpStatefulProperties()
{
  ...
  _initstrain.fillFromInputVector(std::vector<Real>{_functions00.value(0, _q_point[_qp]), _functions01.value(0, _q_point[_qp]), _functions02.value(0, _q_point[_qp]), _functions11.value(0, _q_point[_qp]), _functions12.value(0, _q_point[_qp]), _functions22.value(0, _q_point[_qp])});
